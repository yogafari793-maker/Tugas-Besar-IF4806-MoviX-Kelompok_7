<%-- 
    Document   : jadwal_premier
    Created on : 9 Jun 2026, 10.01.42
    Author     : ghifa
--%>
...
<html>
    <head>
        ...
        <title>Jadwal Premier — MoviX</title>
        <style>
            * { 
                margin:0; 
            ...
            .btn-back {
                padding:10px 18px; background:#1D2432; border:1px solid #323E4F;
            ...
            <div class="main-content">
                ...
                <div class="sidebar">
                    ...
                    <div class="price-box">
                        ...
                        <div class="info-value" id="sidebarHarga">Rp 75.000</div>
                        <form method="post" action="<%= request.getContextPath() %>/jadwal">
                            <input type="hidden" name="tipe"     value="premier"/>
                ...
                <div class="content">
                    <div class="content-title">Pilih Jadwal Film Premier</div>
                    ...
                    <% if (!adaJadwal) { %>
                        <div class="schedule-card">
                            <div class="empty-state">Tidak ada jadwal premier yang tersedia saat ini.</div>
                        </div>
                    <% } else {
